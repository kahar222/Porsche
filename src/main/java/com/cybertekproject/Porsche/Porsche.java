package com.cybertekproject.Porsche;

import static com.cybertekproject.Porsche.Method.countSum;
...
public class Porsche {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// 6. Verify that Base price displayed on the page is same as the price
		// from
		// step 4
		...
		// 8. Verify that total price is the sum of base price + Delivery,
		// Processing
		// and Handling Fee
		...
		// 11.Verify that total price is the sum of base price + Price for
		// Equipment
		...
		// 13.Verify that Price for Equipment is the sum of Miami Blue price +
		// 20"
		...
		// 14.Verify that total price is the sum of base price + Price for
		// Equipment +
		// Delivery, Processing and Handling Fee
		...
		// Package
		// + Interior Trim in Carbon Fiber i.c.w. Standard Interior
		// + 7-speed Porsche Doppelkupplung (PDK) + Porsche Ceramic Composite
		// Brakes
		// (PCCB)
		...
		// 26.Verify that total price is the sum of base price + Price for
		// Equipment
		// + Delivery, Processing and Handling Fee
